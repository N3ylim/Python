...
lista_arquivos = os.listdir("Mentorias/Mentoria Leitura de XML e Notas Fiscais") # lista os nomes dos arquivos de uma pasta
...
for arquivo in lista_arquivos: # para cada arquivo
    if 'xml' in arquivo: # se tem xml no nome do arquivo
        if 'DANFE' in arquivo: # se tem DANFE no nome do arquivo
            print(ler_xml_danfe(f'Mentorias/Mentoria Leitura de XML e Notas Fiscais/{arquivo}')) # rodar o leitor de XML de DANFE para esse arquivo
        else:
